...
namespace D2GitSync.Core
{
    ...
    public interface ID2RLauncherIntegration
    {
        ...
        /// <summary>
        /// Initializes the sync service with specific configuration.
        /// Use this when you have user-configured settings.
        /// </summary>
        Task InitializeAsync(SyncConfiguration configuration, CancellationToken cancellationToken = default);
    ...
    public class D2RLauncherIntegration : ID2RLauncherIntegration, IDisposable
    {
        ...
        _syncService = new D2SaveSyncService();
        ...
        public async Task InitializeAsync(SyncConfiguration configuration, CancellationToken cancellationToken = default)
        {
            _logger.LogInformation("Initializing D2R Save Sync integration with provided configuration");

            // Use the provided configuration
            _configuration = configuration;

            _logger.LogInformation("D2R Save Sync integration initialized with user configuration");
        }
